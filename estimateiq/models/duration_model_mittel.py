"""
Spezialisiertes Laufzeit-Modell für mittlere Projekte (60–365 Tage).

Mittlere Projekte: 2–5 Personen-Teams, 3–12 Monate, moderate Komplexität.
Trainingsdaten: Projekte mit 60 <= dauer_tage <= 365 (gemischte Daten).

Artefakte:
  models/duration_model_mittel.pkl   – {modell, tfidf, svd}
  models/duration_encoders_mittel.pkl – OrdinalEncoder
"""
...
DAUER_MIN    = 60
DAUER_MAX    = 365
KALIBRIERUNG = 0.85   # Gemischte Daten: leichter Abzug für TED-Vergabe-Puffer
MODELL_DIR   = Path("models")
MODELL_PKL   = MODELL_DIR / "duration_model_mittel.pkl"
ENCODER_PKL  = MODELL_DIR / "duration_encoders_mittel.pkl"
...
def train(df: pd.DataFrame, test_anteil: float = 0.20) -> dict:
    """
    Trainiert spezialisiertes Laufzeit-Modell für mittlere Projekte.
